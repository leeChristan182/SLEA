                    ...
                    <tbody>
                        @forelse ($pendingSubmissions as $submission)
                            ...
                            <tr data-submission-id="{{ $submission->id }}">
                                ...
                                <td>
                                    <button class="btn btn-view" data-submission-id="{{ $submission->id }}"
                                        onclick="openSubmissionModalFromButton(this)" title="View Submission">
                        ...
                        <div class="modal-body">
                            <div class="submission-content">
                                ...
                                <div class="info-card">
                                    ...
                                    <div class="card-body">
                                        <div id="rubricMismatchBanner" class="rubric-mismatch-banner d-none" role="alert">
                                        </div>
                                ...
                                <div class="info-card">
                                    ...
                                    <div class="card-body">
                                        <textarea id="assessorRemarks" class="form-control remarks-textarea" rows="4"
                                            placeholder="Enter your remarks and feedback..."></textarea>
