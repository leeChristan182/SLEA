...
@section('content')
        ...
        <main class="main-content">
            ...
            <div class="profile-banner">
                <div class="profile-avatar">
                    ...
                    <form id="avatarForm" method="POST" action="{{ route('assessor.profile.picture') }}"
                            ...
                            <form id="updateForm" method="POST" action="{{ route('assessor.profile.update') }}">
                                ...
                                <div class="info-grid">
                                    ...
                                    <div class="info-field">
                                        ...
                                        <input type="text" class="field-input" name="middle_name"
                                    ...
                                    <div class="info-field">
                                        <label class="field-label">Contact Number</label>
                                        <input type="tel" class="field-input" name="contact"
                                            value="{{ $user->contact ?? '' }}">
                                    </div>
                                </div>
                        ...
                        <div id="passwordEditMode" class="password-edit" style="display:none;">
                            <form id="passwordForm" method="POST" action="{{ route('assessor.password.update') }}">
                                ...
                                <div class="info-field">
                                    ...
                                    <input type="password" class="field-input" name="current_password" id="currentPassword"
                                        required>
                                </div>
                                ...
                                <div class="info-field">
                                    ...
                                    <input type="password" class="field-input" name="password_confirmation"
    ...
    <div id="passwordChangeRequiredModal" class="modal" style="display:none;"
        ...
        <div class="modal-content" style="max-width: 500px;">
            ...
            <div class="modal-body" style="padding: 2rem;">
                ...
                <p style="font-size: 1.1rem; line-height: 1.6; color: #333; margin-bottom: 1rem;">
                    For security purposes, you are required to change your password before accessing other sections of the
                    system.
                </p>
            ...
            <div class="modal-footer" style="padding: 1rem 1.5rem; border-top: 1px solid #ddd; text-align: right;">
                <button type="button" class="btn btn-primary" id="okPasswordChangeModal"
                    style="background-color: #7E0308; border-color: #7E0308; padding: 0.6rem 2rem; font-size: 1rem;">
                    OK
                </button>
            </div>
        </div>
