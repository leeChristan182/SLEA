    ...
    <div class="d-flex flex-column flex-md-row m-0 p-0" style="flex: 1 1 auto; height: 100vh;">
        <div class="login-left flex-shrink-0 flex-fill">
            <div style="max-width: 640px; width: 100%; margin: 0 auto;">
                <h3 class="text-center mb-4 display-5 fw-bold" style="font-family: 'Quicksand', 'sans-seriff';">Welcome, USePians!</h3>
                ...
                {{-- Login Form --}}
                <form method="POST" action="{{ route('login.auth') }}" autocomplete="off" autocapitalize="none" autocorrect="off">
                    @csrf
