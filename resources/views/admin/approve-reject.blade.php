...
@section('content')
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <p class="text-muted" style="margin-top:6px;">
                    ...
                    <br>
                    <small><strong>Note:</strong> Approved students will be <strong>limited</strong> until Initial
                        Validation (Academic + COR + Leadership).</small>
                </p>
            </div>
                ...
                <div class="search-controls">
                    <div class="search-group">
                        <input type="text" id="searchInput" name="q" class="form-control"
                            value="{{ $search ?? request('q') }}" placeholder="Search by Email / Name / User Code">
                    ...
                    <tbody>
                        @forelse($users as $user)
                            ...
                            <tr>
                                ...
                                <td>{{ $fullName ?: '—' }}</td>
                                <td>{{ $user->email }}</td>
                                <td>{{ optional($user->created_at)->setTimezone('Asia/Manila')->format('M d, Y h:i A') ?? '—' }}
                                </td>

                                {{-- Actions column with view button --}}
                                <td>
                                    <button type="button" class="btn-action-view" title="View Actions"
                    ...
                    <div class="action-forms-section">
                        ...
                        <form id="approveForm" method="POST" class="action-form">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <small class="form-text text-muted">
                                    <i class="fas fa-info-circle"></i> Both Student and Assessor accounts will be limited
                                    until they complete their details.
                                </small>
                            </div>
                        ...
                        <form id="rejectForm" method="POST" class="action-form">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="rejection_reason_text" id="rejectionReasonText" class="form-control"
                                    rows="3" placeholder="Enter rejection reason (optional)..." maxlength="500"></textarea>
                                <small class="form-text text-muted">
    ...
    <style>
        ...
        .account-approval-container .submissions-table {
            width: 100%;
            table-layout: fixed;
            /* keeps columns stable and prevents overflow */
        }
        ...
        .account-approval-container .submissions-table td:nth-child(1) {
            width: 18%;
        }

        /* User Code */
        .account-approval-container .submissions-table th:nth-child(2),
        .account-approval-container .submissions-table td:nth-child(2) {
            width: 22%;
        }

        /* Name */
        .account-approval-container .submissions-table th:nth-child(3),
        .account-approval-container .submissions-table td:nth-child(3) {
            width: 26%;
        }

        /* Email */
        .account-approval-container .submissions-table th:nth-child(4),
        .account-approval-container .submissions-table td:nth-child(4) {
            width: 20%;
        }
        ...
        .account-approval-container .submissions-table td:nth-child(5) {
            width: 14%;
            white-space: nowrap;
            /* keep the View button on one line */
        }
