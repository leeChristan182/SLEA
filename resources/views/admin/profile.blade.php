        ...
        <main class="main-content">
            ...
            <div class="profile-banner">
                <div class="profile-avatar">
                    ...
                    <form id="avatarForm" method="POST" action="{{ route('admin.profile.avatar') }}"
                        ...
                        <div id="editMode" class="edit-form" style="display:none;">
                            <form id="updateForm" method="POST" action="{{ route('admin.profile.update') }}"
                                ...
                                <div class="info-grid">
                                    ...
                                    <div class="info-field">
                                        <label class="field-label">Email Address</label>
                                        <input type="email" class="field-input" name="email" value="{{ $admin->email }}"
                                            required>
                                    </div>
                                    <div class="info-field">
                                        <label class="field-label">Contact Number</label>
                            ...
                            <form id="passwordForm" method="POST" action="{{ route('admin.profile.password.update') }}"
                                ...
                                <div class="info-field">
                                    ...
                                    <input type="password" class="field-input" name="password" id="newPassword"
                                        oninput="validatePassword()" required autocomplete="new-password">
                                </div>
                                <div class="info-field">
                                ...
                                <div class="checkbox-field">
                                    <label class="checkbox-label">
                                        <input type="checkbox" id="togglePasswordCheckbox" onclick="togglePassword()"> Show
                                        Password
                                    </label>
                                </div>
