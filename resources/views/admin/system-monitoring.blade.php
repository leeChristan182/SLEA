            ...
            <div class="page-header">
                <div
                    ...
                    <form action="{{ route('admin.system-logs.clear') }}" method="POST"
                        onsubmit="return confirm('Are you sure you want to clear ALL system logs?');" style="margin: 0;">
                        @csrf
                        @method('DELETE')
                ...
                <div class="search-controls">
                    <div class="search-group">
                        <input type="text" name="q" id="searchInput" class="form-control"
                            placeholder="Search by user or description..." value="{{ request('q') }}">
                        <button type="submit" form="filterForm" class="btn-search-maroon search-btn-attached"
                            title="Search">
